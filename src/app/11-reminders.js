  ...
  function applyVars(text, l, extra){
    ...
    const map={
      ...
      '{outstanding}':l?inr(l.outstanding):'', '{arrears}':l?inr(l.arrears||0):'', '{amount}':l?inr(l.emi):'', '{principal}':l?inr(l.principal||0):'', '{fine}':inr(getLateFee()), '{rate}':l?(l.rate+'%'):'',
  ...
  function renderGreetings(){
    ...
    var grMoneyRs=function(l){ var v=grVars(l); if(type==='bounce'||type==='cleared') return v; var o={},M={amount:1,outstanding:1,arrears:1,emi:1,principal:1,fine:1}; for(var k in v){ o[k]=(M[k]&&v[k]!=='' && v[k]!=null)?('₹'+v[k]):v[k]; } return o; };
