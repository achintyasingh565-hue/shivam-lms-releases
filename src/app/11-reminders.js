  ...
  function applyVars(text, l, extra){
    ...
    const map={
      ...
      '{outstanding}':l?inr(l.outstanding):'', '{arrears}':l?inr(l.arrears||0):'', '{amount}':l?inr(l.emi):'', '{principal}':l?inr(l.principal||0):'', '{disbursed}':l?inr(Math.max(0,(Number(l.principal)||0)-(Number(l.deductions)||0))):'', '{fine}':inr(getLateFee()), '{rate}':l?(l.rate+'%'):'',
