  ...
  const WA_TPL_CATS=['EMI Reminder','Overdue Reminder','Greeting / Notice','Office Closure','Payment Confirmation','Loan Approval','Final Notice','Default Notice','Birthday Greeting','Cheque Presentation','Cheque Bounce','Loan Closed','Cheque Cleared','Loan Restructured','Welcome / Account Opened','Business Launched'];
